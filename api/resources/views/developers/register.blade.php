            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('register/app') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" value="{{ old('app_name') }}">
                            ...
                            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="url" class="form-control" name="app_redirect_url" value="{{ old('app_redirect_url') }}">
